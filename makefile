...
dump_spectrum: hashtable.out
	./hashtable.out

hashtable.out: spectrumDumper.cpp vector.cpp hashtable.cpp string_list.cpp utils.cpp vector.hpp hashtable.hpp string_list.hpp utils.hpp
	g++ spectrumDumper.cpp vector.cpp hashtable.cpp string_list.cpp utils.cpp $(CXX_flags) -o hashtable.out 
